...
public class ChatAdapater extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatAdapater(List<ChatMessage> chatMessages, Bitmap receiverProfileImage, String senderId) {
